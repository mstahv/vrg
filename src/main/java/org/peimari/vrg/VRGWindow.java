...
public class VRGWindow extends Window {
	...
	public VRGWindow() {
		...
		addComponent(new Label("<div style='font-size: x-small; text-align:right;'>" + SessionCounter.getAndIncrement() + " sessions since " + initTime + "</div>", Label.CONTENT_XHTML));
